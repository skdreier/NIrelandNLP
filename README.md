...
- [orig_text_data]():
  ...
  + [internment.txt](): Nvivo output text for "Internment" code (first round -- coded at the document level)
  
  + [terrorism.txt](): Nvivo output text for "Internment" code (first round -- coded at the document level)

- [old_files](): Old and/or exploratory scripts and text data corpora.
